...
public class LongApfloatBuilderTest
    extends LongTestCase
{
    public LongApfloatBuilderTest(String methodName)
    {
        super(methodName);
    }
    ...
    public static TestSuite suite()
    {
        ...
        suite.addTest(new LongApfloatBuilderTest("testLongCreate"));
        suite.addTest(new LongApfloatBuilderTest("testDoubleCreate"));
        suite.addTest(new LongApfloatBuilderTest("testStringCreate"));
        suite.addTest(new LongApfloatBuilderTest("testStreamCreate"));
    ...
    {
        ApfloatImpl impl;
        ApfloatBuilder apfloatBuilder = new LongApfloatBuilder();
