...
public class LongDataStorageBuilderTest
    extends LongTestCase
{
    public LongDataStorageBuilderTest(String methodName)
    {
        super(methodName);
    }
    ...
    public static TestSuite suite()
    {
        ...
        suite.addTest(new LongDataStorageBuilderTest("testCreate"));
    ...
    {
        DataStorageBuilder dataStorageBuilder = new LongDataStorageBuilder();
