...
public class DoubleDataStorageBuilderTest
    extends DoubleTestCase
{
    public DoubleDataStorageBuilderTest(String methodName)
    {
        super(methodName);
    }
    ...
    public static TestSuite suite()
    {
        ...
        suite.addTest(new DoubleDataStorageBuilderTest("testCreate"));
    ...
    {
        DataStorageBuilder dataStorageBuilder = new DoubleDataStorageBuilder();
