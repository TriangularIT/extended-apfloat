...
public class LongTwoPassFNTStrategyTest
    extends LongNTTStrategyTestCase
{
    public LongTwoPassFNTStrategyTest(String methodName)
    {
        super(methodName);
    }
    ...
    public static TestSuite suite()
    {
        ...
        suite.addTest(new LongTwoPassFNTStrategyTest("testRoundTrip"));
        suite.addTest(new LongTwoPassFNTStrategyTest("testRoundTripBig"));
        suite.addTest(new LongTwoPassFNTStrategyTest("testRoundTripMultithread"));
        suite.addTest(new LongTwoPassFNTStrategyTest("testRoundTripMultithreadBig"));
