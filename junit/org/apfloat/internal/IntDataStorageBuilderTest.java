...
public class IntDataStorageBuilderTest
    extends IntTestCase
{
    public IntDataStorageBuilderTest(String methodName)
    {
        super(methodName);
    }
    ...
    public static TestSuite suite()
    {
        ...
        suite.addTest(new IntDataStorageBuilderTest("testCreate"));
    ...
    {
        DataStorageBuilder dataStorageBuilder = new IntDataStorageBuilder();
