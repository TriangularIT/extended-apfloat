...
public class IntApfloatBuilderTest
    extends IntTestCase
{
    public IntApfloatBuilderTest(String methodName)
    {
        super(methodName);
    }
    ...
    public static TestSuite suite()
    {
        ...
        suite.addTest(new IntApfloatBuilderTest("testLongCreate"));
        suite.addTest(new IntApfloatBuilderTest("testDoubleCreate"));
        suite.addTest(new IntApfloatBuilderTest("testStringCreate"));
        suite.addTest(new IntApfloatBuilderTest("testStreamCreate"));
    ...
    {
        ApfloatImpl impl;
        ApfloatBuilder apfloatBuilder = new IntApfloatBuilder();
