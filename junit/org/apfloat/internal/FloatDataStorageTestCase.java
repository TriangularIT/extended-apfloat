...
public abstract class FloatDataStorageTestCase
    extends FloatTestCase
{
    protected FloatDataStorageTestCase()
    {
    }

    protected FloatDataStorageTestCase(String methodName)
    {
        super(methodName);
    }
    ...
    public void testGetArray()
    {
        ...
        arrayAccess.getFloatData()[arrayAccess.getOffset() + 1] = (float) 2;
        arrayAccess.getFloatData()[arrayAccess.getOffset() + 2] = (float) 3;
        arrayAccess.getFloatData()[arrayAccess.getOffset() + 3] = (float) 4;
        arrayAccess.close();
    ...
    public void testSubsequence()
    {
        ...
        assertTrue("class", arrayAccess.getData() instanceof float[]);
        assertEquals("sub[0]", 2, (int) arrayAccess.getFloatData()[arrayAccess.getOffset()]);
        assertEquals("sub[1]", 3, (int) arrayAccess.getFloatData()[arrayAccess.getOffset() + 1]);
        ...
        assertTrue("class", arrayAccess.getData() instanceof float[]);
        assertEquals("subsub[0]", 3, (int) arrayAccess.getFloatData()[arrayAccess.getOffset()]);
    ...
    public void testSubsequenceSubArray()
    {
        ...
        arrayAccess.getFloatData()[arrayAccess.getOffset() + 2] = (float) 3;
        arrayAccess.getFloatData()[arrayAccess.getOffset() + 3] = (float) 4;
        arrayAccess.getFloatData()[arrayAccess.getOffset() + 4] = (float) 5;
        arrayAccess.getFloatData()[arrayAccess.getOffset() + 5] = (float) 6;
        arrayAccess.getFloatData()[arrayAccess.getOffset() + 6] = (float) 7;
        arrayAccess.getFloatData()[arrayAccess.getOffset() + 7] = (float) 8;
        arrayAccess.close();
        ...
        assertEquals("sub[0]", 4, (int) newArrayAccess.getFloatData()[newArrayAccess.getOffset()]);
        assertEquals("sub[1]", 5, (int) newArrayAccess.getFloatData()[newArrayAccess.getOffset() + 1]);

        newArrayAccess.getFloatData()[newArrayAccess.getOffset()] = (float) -1;
        newArrayAccess.getFloatData()[newArrayAccess.getOffset() + 1] = (float) -2;
        newArrayAccess.close();
        arrayAccess.close();

        newArrayAccess = newDataStorage.getArray(DataStorage.READ, 0, 6);

        assertEquals("[0]", 2, (int) newArrayAccess.getFloatData()[newArrayAccess.getOffset()]);
        assertEquals("[1]", 3, (int) newArrayAccess.getFloatData()[newArrayAccess.getOffset() + 1]);
        assertEquals("[2]", -1, (int) newArrayAccess.getFloatData()[newArrayAccess.getOffset() + 2]);
        assertEquals("[3]", -2, (int) newArrayAccess.getFloatData()[newArrayAccess.getOffset() + 3]);
        assertEquals("[4]", 6, (int) newArrayAccess.getFloatData()[newArrayAccess.getOffset() + 4]);
        assertEquals("[5]", 7, (int) newArrayAccess.getFloatData()[newArrayAccess.getOffset() + 5]);
    }
    ...
    public void testCopyFrom()
    {
        ...
        assertEquals("[0]", 1, (int) arrayAccess.getFloatData()[arrayAccess.getOffset()]);
        assertEquals("[3]", 4, (int) arrayAccess.getFloatData()[arrayAccess.getOffset() + 3]);
        assertEquals("[4]", 0, (int) arrayAccess.getFloatData()[arrayAccess.getOffset() + 4]);
        assertEquals("[5]", 0, (int) arrayAccess.getFloatData()[arrayAccess.getOffset() + 5]);
        ...
        assertTrue("class", arrayAccess.getData() instanceof float[]);
        assertEquals("[0]", 3, (int) arrayAccess.getFloatData()[arrayAccess.getOffset()]);
        assertEquals("[1]", 4, (int) arrayAccess.getFloatData()[arrayAccess.getOffset() + 1]);
        ...
        assertEquals("[0]", 3, (int) arrayAccess.getFloatData()[arrayAccess.getOffset()]);
        assertEquals("[1]", 4, (int) arrayAccess.getFloatData()[arrayAccess.getOffset() + 1]);
        assertEquals("[2]", 0, (int) arrayAccess.getFloatData()[arrayAccess.getOffset() + 2]);
        assertEquals("[3]", 0, (int) arrayAccess.getFloatData()[arrayAccess.getOffset() + 3]);
    ...
    public void testCopyFromBig()
    {
        ...
        for (int i = 0; i < size; i++)
        {
            assertEquals("[" + i + "]", i + 1, (int) arrayAccess.getFloatData()[arrayAccess.getOffset() + i]);
        }
        arrayAccess.close();
    }
    ...
    public void testIterator()
    {
        ...
        iterator.setFloat((float) 1);
        iterator.next();
        iterator.setFloat((float) 2);
        iterator.next();
        iterator.setFloat((float) 3);
        iterator.next();
        iterator.setFloat((float) 4);
        iterator.next();
        ...
        assertEquals("1st forward read", 2, (int) iterator.getFloat());
        iterator.next();
        assertEquals("2nd forward read", 3, (int) iterator.getFloat());
        iterator.next();
        ...
        assertEquals("1st reverse read", 3, (int) iterator.getFloat());
        iterator.next();
        assertEquals("2nd reverse read", 2, (int) iterator.getFloat());
        iterator.next();
        ...
        assertEquals("1st full reverse read", 4, (int) iterator.getFloat());
        iterator.next();
        assertEquals("2nd full reverse read", 3, (int) iterator.getFloat());
        iterator.next();
        assertEquals("3rd full reverse read", 2, (int) iterator.getFloat());
        iterator.next();
        assertEquals("4th full reverse read", 1, (int) iterator.getFloat());
        iterator.next();
    ...
    public void testIteratorBig()
    {
        ...
        for (int i = 0; i < size; i++)
        {
            assertEquals("[" + i + "]", i + 1, (int) iterator.getFloat());
            iterator.next();
        }
    ...
    public void testSubsequenceIterator()
    {
        ...
        assertEquals("1st forward read", 3, (int) iterator.getFloat());
        iterator.next();
        assertEquals("2nd forward read", 4, (int) iterator.getFloat());
        iterator.next();
        ...
        assertEquals("1st reverse read", 5, (int) iterator.getFloat());
        iterator.next();
        assertEquals("2nd reverse read", 4, (int) iterator.getFloat());
        iterator.next();
        assertEquals("3rd reverse read", 3, (int) iterator.getFloat());
        iterator.next();
        assertEquals("4th reverse read", 2, (int) iterator.getFloat());
        iterator.next();
        ...
        assertEquals("1st subsub read", 4, (int) iterator.getFloat());
        iterator.next();
    ...
    public void testGenericIterator()
    {
        ...
        iterator.set(Float.TYPE, (float) 1);
        iterator.next();

        iterator = dataStorage.iterator(DataStorage.READ, 0, 1);
        assertEquals("read", (float) 1, (float) iterator.get(Float.TYPE));
        iterator.next();
    }
        ...
        throws Exception
    {
        ...
        if (!Integer.TYPE.equals(Float.TYPE))
        {
            try
            {
        ...
        if (!Long.TYPE.equals(Float.TYPE))
        {
            try
            {
                DataStorage.Iterator iterator = dataStorage.iterator(DataStorage.READ, 0, 1);
        ...
        if (!Float.TYPE.equals(Float.TYPE))
        {
            try
            {
                DataStorage.Iterator iterator = dataStorage.iterator(DataStorage.READ, 0, 1);
        ...
        if (!Double.TYPE.equals(Float.TYPE))
        {
            try
            {
                DataStorage.Iterator iterator = dataStorage.iterator(DataStorage.READ, 0, 1);
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            T value = (T) Float.class.getMethod("valueOf", String.class).invoke(null, "0");
        ...
        try
        {
            DataStorage.Iterator iterator = dataStorage.iterator(DataStorage.WRITE, 0, 1);
            @SuppressWarnings("unchecked")
            Class<T> correctType = (Class<T>) Float.TYPE;
