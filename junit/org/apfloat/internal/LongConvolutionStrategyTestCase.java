...
public abstract class LongConvolutionStrategyTestCase
    extends LongTestCase
    implements LongRadixConstants
{
    protected LongConvolutionStrategyTestCase(String methodName)
    {
        super(methodName);
    }

    protected static DataStorage createDataStorage(long[] data)
    {
    ...
    protected static void check(String message, int radix, long[] expected, DataStorage actual)
    {
