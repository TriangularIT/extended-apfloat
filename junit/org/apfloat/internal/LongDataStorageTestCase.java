...
public abstract class LongDataStorageTestCase
    extends LongTestCase
{
    protected LongDataStorageTestCase()
    {
    }

    protected LongDataStorageTestCase(String methodName)
    {
        super(methodName);
    }
    ...
    public void testGetArray()
    {
        ...
        arrayAccess.getLongData()[arrayAccess.getOffset() + 1] = (long) 2;
        arrayAccess.getLongData()[arrayAccess.getOffset() + 2] = (long) 3;
        arrayAccess.getLongData()[arrayAccess.getOffset() + 3] = (long) 4;
        arrayAccess.close();
    ...
    public void testSubsequence()
    {
        ...
        assertTrue("class", arrayAccess.getData() instanceof long[]);
        assertEquals("sub[0]", 2, (int) arrayAccess.getLongData()[arrayAccess.getOffset()]);
        assertEquals("sub[1]", 3, (int) arrayAccess.getLongData()[arrayAccess.getOffset() + 1]);
        ...
        assertTrue("class", arrayAccess.getData() instanceof long[]);
        assertEquals("subsub[0]", 3, (int) arrayAccess.getLongData()[arrayAccess.getOffset()]);
    ...
    public void testSubsequenceSubArray()
    {
        ...
        arrayAccess.getLongData()[arrayAccess.getOffset() + 2] = (long) 3;
        arrayAccess.getLongData()[arrayAccess.getOffset() + 3] = (long) 4;
        arrayAccess.getLongData()[arrayAccess.getOffset() + 4] = (long) 5;
        arrayAccess.getLongData()[arrayAccess.getOffset() + 5] = (long) 6;
        arrayAccess.getLongData()[arrayAccess.getOffset() + 6] = (long) 7;
        arrayAccess.getLongData()[arrayAccess.getOffset() + 7] = (long) 8;
        arrayAccess.close();
        ...
        assertEquals("sub[0]", 4, (int) newArrayAccess.getLongData()[newArrayAccess.getOffset()]);
        assertEquals("sub[1]", 5, (int) newArrayAccess.getLongData()[newArrayAccess.getOffset() + 1]);

        newArrayAccess.getLongData()[newArrayAccess.getOffset()] = (long) -1;
        newArrayAccess.getLongData()[newArrayAccess.getOffset() + 1] = (long) -2;
        newArrayAccess.close();
        arrayAccess.close();

        newArrayAccess = newDataStorage.getArray(DataStorage.READ, 0, 6);

        assertEquals("[0]", 2, (int) newArrayAccess.getLongData()[newArrayAccess.getOffset()]);
        assertEquals("[1]", 3, (int) newArrayAccess.getLongData()[newArrayAccess.getOffset() + 1]);
        assertEquals("[2]", -1, (int) newArrayAccess.getLongData()[newArrayAccess.getOffset() + 2]);
        assertEquals("[3]", -2, (int) newArrayAccess.getLongData()[newArrayAccess.getOffset() + 3]);
        assertEquals("[4]", 6, (int) newArrayAccess.getLongData()[newArrayAccess.getOffset() + 4]);
        assertEquals("[5]", 7, (int) newArrayAccess.getLongData()[newArrayAccess.getOffset() + 5]);
    }
    ...
    public void testCopyFrom()
    {
        ...
        assertEquals("[0]", 1, (int) arrayAccess.getLongData()[arrayAccess.getOffset()]);
        assertEquals("[3]", 4, (int) arrayAccess.getLongData()[arrayAccess.getOffset() + 3]);
        assertEquals("[4]", 0, (int) arrayAccess.getLongData()[arrayAccess.getOffset() + 4]);
        assertEquals("[5]", 0, (int) arrayAccess.getLongData()[arrayAccess.getOffset() + 5]);
        ...
        assertTrue("class", arrayAccess.getData() instanceof long[]);
        assertEquals("[0]", 3, (int) arrayAccess.getLongData()[arrayAccess.getOffset()]);
        assertEquals("[1]", 4, (int) arrayAccess.getLongData()[arrayAccess.getOffset() + 1]);
        ...
        assertEquals("[0]", 3, (int) arrayAccess.getLongData()[arrayAccess.getOffset()]);
        assertEquals("[1]", 4, (int) arrayAccess.getLongData()[arrayAccess.getOffset() + 1]);
        assertEquals("[2]", 0, (int) arrayAccess.getLongData()[arrayAccess.getOffset() + 2]);
        assertEquals("[3]", 0, (int) arrayAccess.getLongData()[arrayAccess.getOffset() + 3]);
    ...
    public void testCopyFromBig()
    {
        ...
        for (int i = 0; i < size; i++)
        {
            assertEquals("[" + i + "]", i + 1, (int) arrayAccess.getLongData()[arrayAccess.getOffset() + i]);
        }
        arrayAccess.close();
    }
    ...
    public void testIterator()
    {
        ...
        iterator.setLong((long) 1);
        iterator.next();
        iterator.setLong((long) 2);
        iterator.next();
        iterator.setLong((long) 3);
        iterator.next();
        iterator.setLong((long) 4);
        iterator.next();
        ...
        assertEquals("1st forward read", 2, (int) iterator.getLong());
        iterator.next();
        assertEquals("2nd forward read", 3, (int) iterator.getLong());
        iterator.next();
        ...
        assertEquals("1st reverse read", 3, (int) iterator.getLong());
        iterator.next();
        assertEquals("2nd reverse read", 2, (int) iterator.getLong());
        iterator.next();
        ...
        assertEquals("1st full reverse read", 4, (int) iterator.getLong());
        iterator.next();
        assertEquals("2nd full reverse read", 3, (int) iterator.getLong());
        iterator.next();
        assertEquals("3rd full reverse read", 2, (int) iterator.getLong());
        iterator.next();
        assertEquals("4th full reverse read", 1, (int) iterator.getLong());
        iterator.next();
    ...
    public void testIteratorBig()
    {
        ...
        for (int i = 0; i < size; i++)
        {
            assertEquals("[" + i + "]", i + 1, (int) iterator.getLong());
            iterator.next();
        }
    ...
    public void testSubsequenceIterator()
    {
        ...
        assertEquals("1st forward read", 3, (int) iterator.getLong());
        iterator.next();
        assertEquals("2nd forward read", 4, (int) iterator.getLong());
        iterator.next();
        ...
        assertEquals("1st reverse read", 5, (int) iterator.getLong());
        iterator.next();
        assertEquals("2nd reverse read", 4, (int) iterator.getLong());
        iterator.next();
        assertEquals("3rd reverse read", 3, (int) iterator.getLong());
        iterator.next();
        assertEquals("4th reverse read", 2, (int) iterator.getLong());
        iterator.next();
        ...
        assertEquals("1st subsub read", 4, (int) iterator.getLong());
        iterator.next();
    ...
    public void testGenericIterator()
    {
        ...
        iterator.set(Long.TYPE, (long) 1);
        iterator.next();

        iterator = dataStorage.iterator(DataStorage.READ, 0, 1);
        assertEquals("read", (long) 1, (long) iterator.get(Long.TYPE));
        iterator.next();
    }
        ...
        throws Exception
    {
        ...
        if (!Integer.TYPE.equals(Long.TYPE))
        {
            try
            {
        ...
        if (!Float.TYPE.equals(Long.TYPE))
        {
            try
            {
                DataStorage.Iterator iterator = dataStorage.iterator(DataStorage.READ, 0, 1);
        ...
        if (!Double.TYPE.equals(Long.TYPE))
        {
            try
            {
                DataStorage.Iterator iterator = dataStorage.iterator(DataStorage.READ, 0, 1);
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            T value = (T) Long.class.getMethod("valueOf", String.class).invoke(null, "0");
        ...
        try
        {
            DataStorage.Iterator iterator = dataStorage.iterator(DataStorage.WRITE, 0, 1);
            @SuppressWarnings("unchecked")
            Class<T> correctType = (Class<T>) Long.TYPE;
