...
public class IntFactor3NTTStrategyTest
    extends IntNTTStrategyTestCase
{
    public IntFactor3NTTStrategyTest(String methodName)
    {
        super(methodName);
    }
    ...
    public static TestSuite suite()
    {
        ...
        suite.addTest(new IntFactor3NTTStrategyTest("testForward"));
        suite.addTest(new IntFactor3NTTStrategyTest("testRoundTrip"));
        suite.addTest(new IntFactor3NTTStrategyTest("testRoundTripParallel"));
        suite.addTest(new IntFactor3NTTStrategyTest("testRoundTrip2"));
        suite.addTest(new IntFactor3NTTStrategyTest("testRoundTrip2Parallel"));
    ...
    public static void testForward()
    {
        for (int modulus = 0; modulus < 3; modulus++)
        {
            ...
            NTTStrategy nttStrategy = new Factor3NTTStrategy(new IntTableFNTStrategy());
    ...
    private static void runRoundTrip2()
    {
        ...
        for (int modulus = 0; modulus < 3; modulus++)
        {
            Factor3NTTStrategy nttStrategy = new Factor3NTTStrategy(new IntTableFNTStrategy());
