...
public class FloatApfloatBuilderTest
    extends FloatTestCase
{
    public FloatApfloatBuilderTest(String methodName)
    {
        super(methodName);
    }
    ...
    public static TestSuite suite()
    {
        ...
        suite.addTest(new FloatApfloatBuilderTest("testLongCreate"));
        suite.addTest(new FloatApfloatBuilderTest("testDoubleCreate"));
        suite.addTest(new FloatApfloatBuilderTest("testStringCreate"));
        suite.addTest(new FloatApfloatBuilderTest("testStreamCreate"));
    ...
    {
        ApfloatImpl impl;
        ApfloatBuilder apfloatBuilder = new FloatApfloatBuilder();
